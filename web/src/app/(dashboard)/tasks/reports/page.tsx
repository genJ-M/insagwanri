      ...
      <main className="p-6 space-y-4">
        ...
        <Card>
          <div className="flex flex-wrap items-end gap-3">
            <Filter className="h-4 w-4 text-gray-400 mt-5 flex-shrink-0" />
            <div>
          ...
          {isLoading ? (
            ...
            <>
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex-1 min-w-0">
                          ...
                          {taskTitle && (
                            <Link
                              href="/tasks"
                              className="inline-flex items-center gap-1 text-xs text-blue-600 font-medium mb-1 hover:underline"
                            >
                          ...
                          {safePct != null && (
                            <div className="mt-2 flex items-center gap-2">
                              ...
                              <span className="text-xs text-gray-500 tabular-nums">{safePct}%</span>
                            </div>
                          )}
                          ...
                          {r.feedback && (
                            <div className="mt-2 px-3 py-2 bg-yellow-50 border border-yellow-200 rounded-lg">
                              ...
                              <p className="text-xs text-yellow-800">{r.feedback}</p>
                            </div>
                          )}
                        </div>
              ...
              <div className="px-5 py-2 border-t border-gray-100">
                <p className="text-xs text-gray-400">총 {reports?.length ?? 0}건</p>
              </div>
            </>
          )}
        </Card>
